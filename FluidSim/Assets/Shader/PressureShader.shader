	...
	SubShader {
		...
		Pass {
			...
			v2f vert (appdata_full v, uint instanceID : SV_InstanceID)
			{
				...
				float averagePressure = Pressure[instanceID] / maxValue;
				o.colour = ColourMap.SampleLevel(linear_clamp_sampler, float2(averagePressure, 0.5), 0);
				return o;	
			}
